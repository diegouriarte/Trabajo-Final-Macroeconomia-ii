...
var c       $c$ %consumo
    k       $k$ %capital
    a       $a$ %choque de productividad
    h       $h$ %horas trabajas en el periodo t
    d       $d$ %stock de deuda en el periodo t
    y       $y$ %producto
    invest  $i$  %inversión
    tb      $tb$ %trade balance: exports - imports
    mu_c    ${MU_C}$ %utilidad marginal del consumo
    tb_y    ${\frac{TB}{Y}}$ %ratio tb / producto
    g_y     ${\Delta Y}$ %tasa de crecimiento del producto
    g_c     ${\Delta C}$ %tasa de crecimiento del consumo
    g_invest ${\Delta I}$ %tasa de crecimiento de la inversión
    g       ${g}$ %tasa de crecimiento del choque de productividad Xt/Xt+1
    r       ${r}$ %tasa de interés
    mu      ${\mu}$ %shock estocástico al premium del país
    nu      ${\nu}$ %shock estocástico de preferencias
    @#if RBC == 0
    s       ${s}$ %shock estocástico de gasto doméstico
    @# endif
; 
...
stoch_simul(loglinear,order=1,irf=40) g_y g_c g_invest tb_y;
%stoch_simul;
