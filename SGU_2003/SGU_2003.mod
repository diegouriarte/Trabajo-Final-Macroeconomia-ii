...
%Table 1
gamma  = 2; %risk aversion original 2
omega  = 1.5; %Frisch-elasticity parameter original 1.455, ultimo 1.5
psi_1  = 0; %set in steady state %elasticity discount factor w.r.t. to arguments of utility function
alpha  = 0.26; %labor share valor original 0.32
phi    = 0.014; %capital adjustment cost parameter valor original 0.028
r_bar    = 1.04^(1/4)-1; %world interest rate de 4%		
delta  = 1.1^(1/4)-1; %depreciation rate para pasar a data trimestral 10% anual
rho    = 0.7; %autocorrelation TFP valor origilan 0.42
sigma_tfp = 0.0129; %standard deviation TFP valor original 0.0129

%Table 2
psi_2    = 0.0025; %valor original 0.000742
d_bar  = 0.7442; %valor original 0.7442
